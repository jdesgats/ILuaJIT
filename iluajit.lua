...
--
-- Known issues:
--     * lfs completion crashes the shell on unknown folders
--     * Internal ILuaJIT function are shown in error tracebacks
--
...
--     * Make an extra global variable to customize shell (prompts, error handler, table pretty printing)
